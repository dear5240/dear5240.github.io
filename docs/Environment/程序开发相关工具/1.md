...
1. 下载并安装 [Windows版Code::Blocks（点击此处下载）](https://doc.yunthinker.com/downloads/codeblocks-latest.exe )
...
在浏览器中打开链接：[Code::Blocks Windows版本（点击此处下载）](https://doc.yunthinker.com/downloads/codeblocks-latest.exe )
